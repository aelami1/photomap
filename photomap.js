...
function createPhotoMap () {
  ...
  var csvUrl = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTzmItoTlwH7L3ia4XnZ_edKsWs1m-nThRgk7nlss3ym6IXO4lPZvpSIR8s_EIZEQbrz84bSE6uTu6R/pub?gid=0&single=true&output=csv';
  ...
  var basemap = L.tileLayer ('https://tiles.stadiamaps.com/tiles/alidade_satellite/{z}/{x}/{y}{r}.{ext}', {
	maxZoom: 20,
